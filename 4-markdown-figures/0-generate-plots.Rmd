...
# Facet wrap by index
a4 <- ggplot(tissue_at_risk_long, aes(x = type, y = score)) +
  ...
  #  c("Normal", "Normal_adjacent"), # insignificant in all
    c("Normal", "Triple_negative_tumour")),
                               label = 'p.format', step.increase = 0.13, vjust = 0,textsize=1, hide.ns = T) +
...
c4 <- tcga_long |>
  ...
  ggpubr::stat_compare_means(comparisons = list(c("Control", "Cancer")),
                             label = 'p.format',
                             hide.ns = T, step.increase = 0.13, vjust = 0,textsize=1) +
 labs(fill = "index") +
  labs(y = '',
...
# Facet wrap by index
e4 <- ggplot(GSE225845_long, aes(x = type, y = score)) +
  geom_boxplot(aes(fill = index), cex = 0.5, fatten = 2) +
  ggbeeswarm::geom_beeswarm(alpha = 0.5, size = 0.5) +
  labs(
    x = "",
...
# Extended Data 1: PCA plot of all data
...
# Extended Data 2: Index training and evaluation 
...
# Extended Data 3: IC and cell types in the discovery and external validation sets
...
UPDATE APRIL 2024: This figure is replaced by the new Extended Data Figure 1, with all PCA plots.
