...
ridge_epi <- combine_sets(res_ridge, "Ridge - Low Neutro", type = 'all')
lasso_epi <- combine_sets(res_lasso, "Lasso - Low Neutro", type = 'all')

load(here("2-training", foldername, "res_ridge_imm.Rdata"))
load(here("2-training", foldername, "res_lasso_imm.Rdata"))
ridge_imm <- combine_sets(res_ridge, "Ridge - High Neutro", type = 'all')
lasso_imm <- combine_sets(res_lasso, "Lasso - High Neutro", type = 'all')
...
pdat$Type <- factor(pdat$Type, levels = c("Ridge - Combined", "Lasso - Combined", "Ridge - Low Neutro", "Lasso - Low Neutro", "Ridge - High Neutro", "Lasso - High Neutro", "Ridge - pval", "Lasso - pval"))
