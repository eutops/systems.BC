---
title: "DMR analysis in cervical samples"
...
# Settings
here::i_am("1-ewas/2-cervical/2-dmrs.Rmd")
set = 'discovery_cervical'
sampletype = 'cervical'
...
hist(ranges$Stouffer)

sum(ranges$Stouffer<0.05)
sum(ranges$HMFDR<0.05)
