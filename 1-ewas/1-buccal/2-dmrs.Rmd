---
title: "DMR analysis in buccal samples"
...
# Settings
here::i_am("1-ewas/1-buccal/2-dmrs.Rmd")
set = 'discovery_buccal'
sampletype = 'buccal'
foldername = '1-buccal'
...
```{r}
pdf(file = here("1-ewas", foldername, "2-output", "dmr_buccal_discovery.pdf"),
    width = 9, height = 5)
...
# set pheno and beta
pheno <- data[data$set=='validation_buccal' & data$sampletype==sampletype,]
beta <- coerce_numeric(beta_merged[,pheno$basename])

pdf(file = here("1-ewas", foldername, "2-output", "dmr_buccal_validation.pdf"),
    width = 9, height = 5)
plotDMRs(ranges = ranges_filtered,
          beta = beta,
          pheno = pheno,
