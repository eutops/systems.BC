...
Buccal (red), cervical (blue) - some peaks seem to overlap
...
* This also explains why the cervical and buccal index likely go in opposite directions
* We could do the same check looking at DMPs (i.e. checking direction of p-adjusted type-coef in delta-beta in cervical and buccal)
...
# Delta-beta in epithelial cells of DMPs
...
# Delta-beta in immune cells of DMPs
