...
# load(file.path(db_path,"eca/bc-blood/MattersArising_BloodBC/data/cent12CT.m.rda")) # epiDISH reference matrix

# Check if pheno and beta are in the same order
if(!identical(pheno_trimmed$basename, colnames(beta_merged))){
